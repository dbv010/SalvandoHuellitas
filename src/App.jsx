...
const App = () => {
    ...
    const renderPage = () => {
        switch (currentPage) {
            case 'Animales':
                return <CategoryPage title="Artículos para mascotas" category="Animales" onAddToCart={addToCart} />;
            case 'Medicinas':
                return <CategoryPage title="Medicamentos" category="Medicinas" onAddToCart={addToCart} />;
            case 'Donaciones':
                return <CategoryPage title="Aporta tu granito de arena mandando tu ayuda a este número de cuenta: 83473 39376" category="Donaciones" onAddToCart={addToCart} />;
            case 'Acerca de nosotros':
                return <CategoryPage title="¿Quiénes somos?" category="Acerca de nosotros" onAddToCart={addToCart} />;
            case 'cart':
                return (
                    <CartPage 
                        cart={cart}
