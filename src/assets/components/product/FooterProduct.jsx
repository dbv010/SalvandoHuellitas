...
const Footer = () => (
    <footer className="bg-teal-900 text-gray-300 pt-12">
        <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
                {/* Columna de la marca */}
                <div className="md:col-span-1 mb-6 md:mb-0">
                    <h3 className="font-black text-2xl text-white tracking-wider mb-4">Salvando Huellitas</h3>
                    <p className="text-sm">Porque ignorar el sufrimiento no es una opción.</p>
                </div>
                {/* Columnas de enlaces */}
                <div>
                    <h4 className="font-bold uppercase text-white mb-4">Sobre la marca</h4>
                    <a href="#" className="block mb-2 hover:text-purple-950 transition">Nosotros</a>
                    <a href="#" className="block mb-2 hover:text-purple-950 transition">Cultura</a>
                    <a href="#" className="block mb-2 hover:text-purple-950 transition">Trabaja aquí</a>
                </div>
                <div>
                    <h4 className="font-bold uppercase text-white mb-4">Ayuda</h4>
                    <a href="#" className="block mb-2 hover:text-purple-950 transition">Envíos</a>
                    <a href="#" className="block mb-2 hover:text-purple-950 transition">Seguimiento</a>
                    <a href="#" className="block mb-2 hover:text-purple-950 transition">Preguntas Frecuentes</a>
                </div>
                 <div>
                    <h4 className="font-bold uppercase text-white mb-4">Contacto</h4>
                    <p className="mb-2">Email: contacto@salvandohuellitas.com</p>
                    <p className="mb-2">Tel: +57 322 394 9352</p>
            ...
            <div className="mt-8 py-4 border-t border-gray-700 text-center text-sm">
                <p>&copy; {new Date().getFullYear()} Salvando Huellitas. Todos los derechos reservados.</p>
