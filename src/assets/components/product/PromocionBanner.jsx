import caninos from '../../images/Caninos.jpg';
import felinos from '../../images/Felinos.jpg';
import equinos from '../../images/Equinos.jpg';  
...
const collectionSlides = [
    {
        ...
        subtitle: 'Enigma silencioso.'
    },
    {
        img:caninos,
        title: 'Para perros',
        subtitle: 'Epítome de la lealtad.'
    },
    {
        img:equinos,
        title: 'Para caballos',
        subtitle: 'Símbolo de libertad, poder y nobleza.'
    },
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="relative rounded-xl overflow-hidden h-[28rem] group shadow-2xl">
                    ...
                    <div className="absolute bottom-0 left-0 p-8 text-white">
                        ...
                        <a href="#" className="mt-2 inline-block font-semibold bg-teal-200 text-black py-3 px-8 rounded-full shadow-lg hover:bg-white hover:text-gray-800 transition-all duration-300 transform group-hover:scale-105">
                            Descubrir
                        </a>
                    </div>
                ...
                <div className="relative rounded-xl overflow-hidden h-[28rem] flex items-center justify-center p-8 bg-gray-900 group shadow-2xl">
                    <div className="absolute w-64 h-64 bg-gradient-to-br from-teal-500 to-teal-900 rounded-full -top-10 -left-10 opacity-60 animate-blob"></div>
                    <div className="absolute w-72 h-72 bg-gradient-to-br from-purple-500 to-purple-950 rounded-full -bottom-10 -right-10 opacity-60 animate-blob animation-delay-2000"></div>
                    <div className="absolute w-56 h-56 bg-gradient-to-br from-amber-100 to-blue-950 rounded-full -bottom-10 -left-10 opacity-50 animate-blob animation-delay-4000"></div>
                    ...
                    <div className="relative z-10 text-center text-white bg-white/10 backdrop-blur-xl p-8 rounded-lg border border-white/20 shadow-lg">
                        <h3 className="text-3xl font-bold mb-2 transition-transform duration-500 group-hover:scale-105">Todo a mitad de precio</h3>
                        <p className="mb-4 text-md">Ofertas y promociones</p>
                        <a href="#" className="mt-2 inline-block font-semibold bg-purple-200 text-black py-3 px-8 rounded-full shadow-lg hover:bg-white hover:text-gray-800 transition-all duration-300 transform group-hover:scale-105">
                            Visualizar
                        </a>
                    </div>
                </div>
