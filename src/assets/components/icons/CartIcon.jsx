...
const CartIcon = ({ className = "" }) => {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"  // ← usa el color actual (permite Tailwind)
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`w-6 h-6 ${className}`}  // ← permite pasar color con Tailwind
    >
      <path d="M9 21C9.55228 21 10 20.5523 10 20C10 19.4477 9.55228 19 9 19C8.44772 19 8 19.4477 8 20C8 20.5523 8.44772 21 9 21Z" />
